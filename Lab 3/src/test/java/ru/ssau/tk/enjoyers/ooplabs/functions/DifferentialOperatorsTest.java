...
class DifferentialOperatorsTest {
    ...
    void testTabulatedDifferentialOperator() {
        ...
        double[] yValues = {0.0, 1.0, 4.0, 9.0}; // x^2
        ...
        assertEquals(0.0, derivative.getY(0), 0.1); // at x=0: 2*0=0
        assertEquals(2.0, derivative.getY(1), 0.1); // at x=1: 2*1=2
        assertEquals(4.0, derivative.getY(2), 0.1); // at x=2: 2*2=4
        assertEquals(4.0, derivative.getY(3), 0.1); // last point same as previous
    }
